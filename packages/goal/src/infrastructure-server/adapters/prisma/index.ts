...
export { GoalFolderRepositoryPrisma } from './goal-folder-prisma.repository';
...
export { GoalFolderRepositoryPrisma as GoalFolderPrismaRepository } from './goal-folder-prisma.repository';
export { GoalStatisticsRepositoryPrisma as GoalStatisticsPrismaRepository } from './goal-statistics-prisma.repository';
