...
import type { IFocusSessionRepository, IGoalRepository } from '@/domain-server';
import { FocusSessionDomainService, FocusSession, Goal } from '@/domain-server';
...
export class FocusSessionApplicationService {
  ...
  constructor(sessionRepository: IFocusSessionRepository, goalRepository: IGoalRepository) {
