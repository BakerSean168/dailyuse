...
/**
 * Goal ownership surface (stage-6 residual 117):
 * get/update/delete + record create/delete must identity-scope repository reads —
 * never authorize by bare goal/record primary key alone.
 */
