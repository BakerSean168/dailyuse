...
import { GoalReminderConfig, GoalId, GoalFolderId } from '../value-objects';
import { GoalStatus } from '@dailyuse/contracts/goal';
import type { GoalReminderConfigDTO } from '@dailyuse/contracts/goal';
...
export class GoalDomainService {
  ...
  public createGoal(
    params: {
      ...
      folderId?: string;
      parentGoalId?: string;
      reminderConfig?: GoalReminderConfigDTO;
      color?: string;
    ...
    const reminderConfig = params.reminderConfig
      ? GoalReminderConfig.fromDTO(params.reminderConfig)
      : null;
    ...
    const goal = Goal.create({
      ...
      folderId: (params.folderId ?? null) as GoalFolderId | null,
      parentGoalId: (params.parentGoalId ?? null) as GoalId | null,
      reminderConfig,
    });
