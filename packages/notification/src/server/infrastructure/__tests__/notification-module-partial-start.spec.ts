/**
 * createNotificationModule partial-start cleanup spec.
 * createNotificationModule 部分启动回滚测试。
 *
...
import type { INotificationTemplateRepository } from '../../domain/repositories';
...
interface FakeContribution {
  ...
  readonly contribution: NotificationModuleRuntimeContribution;
}
...
function makeDeps(
  runtimeContributions: NotificationModuleRuntimeContribution[],
  ...
  return {
    ...
    templateRepository: {} as unknown as INotificationTemplateRepository,
...
describe('createNotificationModule partial-start cleanup', () => {
