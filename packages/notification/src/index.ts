 ...
 * 【分层架构】
 *
 * contracts           → 类型定义、DTO、事件、API Schema（@dailyuse/contracts/notification）
 ...
 *
 * // 2. 导入服务端聚合根
 * import { Notification } from '@dailyuse/notification/domain-server';
 *
 * // 3. 导入基础设施模块
 * import { NotificationModule } from '@dailyuse/notification/infrastructure-server';
 * ```
 */
