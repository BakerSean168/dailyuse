 ...
 * @param complexity 任务复杂�?('simple', 'medium', 'complex')
...
export const TIME_ESTIMATION_USER_PROMPT_TEMPLATE = (
  ...
  const complexityInfo = complexity
    ? `任务复杂度：${complexity === 'simple' ? '简�? : complexity === 'medium' ? '中等' : '复杂'}\n`
    : '';
