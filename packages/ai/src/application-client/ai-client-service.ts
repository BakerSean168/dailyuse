 ...
 *
 * Most AI client ports return Result envelopes (residual 96–99). Message send/list
 * return Result; streamMessage still throw-based; agent runtime still throw-unwrap.
 *
