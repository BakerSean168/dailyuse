/**
 * AI Module - PowerSync Composition Root
 */
...
export class AIPowerSyncModule {
  ...
  constructor(dbConnection: IElectronDatabase) {
    const conversationRepository = new PowerSyncAIConversationRepository(dbConnection);
    const providerConfigRepository = new PowerSyncAIProviderConfigRepository(dbConnection);
...
export { PowerSyncAIConversationRepository, PowerSyncAIProviderConfigRepository, AIContainer };
