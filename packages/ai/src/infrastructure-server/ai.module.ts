...
/**
 * @deprecated Use `createAIModule()` composition root instead.
 * @deprecated 请使用 `createAIModule()` 组合根替代。
 *
 * Kept for backward compatibility with callers that still use `new AIModule(...)`.
 */
export class AIModule {
  ...
  constructor(deps: AIModuleDependencies) {
    this._instance = createAIModule(deps);
    ...
    // Map use cases
    this.createConversation = this._instance.useCases.createConversation;
    this.deleteConversation = this._instance.useCases.deleteConversation;
    this.listConversations = this._instance.useCases.listConversations;
    this.listProviders = this._instance.useCases.listProviders;
    this.getConversation = this._instance.useCases.getConversation;
    this.sendMessage = this._instance.useCases.sendMessage;
    this.generateGoal = this._instance.useCases.generateGoal;
