/**
 * Provider config repository surface (stage-6 residual):
 * Host path only uses save/findById/findByIdentityId/findDefaultByIdentityId/delete/clearDefaultForIdentity.
 */
