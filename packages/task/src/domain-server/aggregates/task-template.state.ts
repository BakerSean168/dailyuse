...
import type { TaskTemplateStatus } from '../../domain-shared/value-objects/task-template-status';
import type { TaskTemplateId } from '../../domain-shared/value-objects/task-template-id';
import type { TaskFolderId } from '../../domain-shared/value-objects/task-folder-id';
import type {
