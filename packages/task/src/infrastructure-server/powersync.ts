...
export class TaskPowerSyncModule {
  ...
  constructor(dbConnection: Queryable) {
    const taskTemplateRepository = new PowerSyncTaskTemplateRepository(dbConnection);
    const taskInstanceRepository = new PowerSyncTaskInstanceRepository(dbConnection);
    const taskDependencyRepository = new PowerSyncTaskDependencyRepository(dbConnection);
    const taskFolderRepository = new PowerSyncTaskFolderRepository(dbConnection);
