...
export class DeviceInfo extends ValueObject<DeviceInfoDTO> implements IDeviceInfo {
  ...
  public getTypeDisplayName(): string {
    return DeviceType.getDisplayName(this.props.deviceType as DeviceType);
  }
