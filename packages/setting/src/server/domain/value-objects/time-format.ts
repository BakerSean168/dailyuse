import { TimeFormat as TimeFormatContract, type TimeFormat as ITimeFormat } from '@dailyuse/contracts/setting';
...
const VALUES: ITimeFormat[] = Object.values(TimeFormatContract);
