/**
 * createSettingModule partial-start cleanup spec.
 * createSettingModule 部分启动回滚测试。
 *
...
interface FakeContribution {
  ...
  readonly contribution: SettingModuleRuntimeContribution;
}
...
function makeDeps(runtimeContributions: SettingModuleRuntimeContribution[]): SettingModuleDependencies {
  return {
    userSettingRepository: {} as unknown as IUserSettingRepository,
