  ...
  resolve: {
    alias: [
      // Contracts subpath aliases (specific first)
      {
        ...
        replacement: path.join(contractsRoot, 'primitives/index.ts'),
      },
      {
        find: '@dailyuse/contracts/setting',
        replacement: path.join(contractsRoot, 'modules/setting/index.ts'),
      },
      {
        find: '@dailyuse/contracts/result',
        replacement: path.join(contractsRoot, 'result/index.ts'),
      },
      {
        find: '@dailyuse/contracts/shared',
        replacement: path.join(contractsRoot, 'shared/index.ts'),
      },
      {
        find: '@dailyuse/contracts/mocks',
        replacement: path.join(contractsRoot, 'mocks/index.ts'),
      },
      ...
      // Other packages
      {
        ...
        replacement: path.resolve(root, 'packages/database/src/index.ts'),
      },
      {
        find: '@dailyuse/domain-shared/shared',
        replacement: path.resolve(root, 'packages/domain-shared/src/shared/index.ts'),
      },
      {
        find: '@dailyuse/domain-shared',
        replacement: path.resolve(root, 'packages/domain-shared/src/index.ts'),
      },
