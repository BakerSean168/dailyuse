<template>
  <Card class="group cursor-pointer transition hover:-translate-y-0.5 hover:shadow-md" @click="handleOpenGoal">
    ...
    <CardContent class="space-y-3 pt-0">
      ...
      <div class="space-y-2 rounded-md border bg-muted/20 p-2">
        <div class="flex items-center justify-between text-xs">
          <span class="font-medium text-muted-foreground">关键结果</span>
