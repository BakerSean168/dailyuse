export default {
  ...
  "configureProviderNotice": "Configure an OpenAI-compatible provider in Settings before using AI features.",
  ...
  "chatPage": {
    ...
    "emptyModels": "No model is available yet. Open Settings to configure an AI provider and sync models.",
    "context": {
      "title": "Context",
      "show": "Show context",
      "hide": "Hide context",
      ...
      "hostReceiptSubtitle": "Post-approval execution outcomes (lifecycle receipt, not kernel mutation execution)",
      "hostReceiptPending": "{count} execution report(s)",
      "hostReceiptKindGoal": "Goal create",
      "hostReceiptKindKnowledge": "Knowledge write",
      "hostReceiptKindTask": "Task create",
    ...
    "toolIntro": {
      "goalCreate": {
        ...
        "description": "Use the conversation to clarify scope, constraints, success criteria, and timing, then turn it into a structured goal draft."
      },
      "knowledgeQa": {
        "title": "Ask Your Knowledge Base",
        "description": "Ask from indexed repository knowledge. Answers should be grounded in citations when evidence is available."
      },
      "knowledgeGenerate": {
        "title": "Start A Knowledge Note",
        "description": "Use the conversation to clarify the topic, source, and key takeaways, then create the markdown note directly in the background."
      },
      "taskCreate": {
        "title": "Plan A Task",
        "description": "Clarify the task title, optional goal link, and acceptance notes, then review a Host task.create proposal before creation."
      }
    },
    "shortcuts": {
      "chat": {
    ...
    "workflow": {
      ...
      "toolButton": "Intent",
      "goalCollectingHint": "Keep adding context in chat, then generate a structured goal draft when ready.",
      "goalClarificationHint": "The draft needs a few clarifications before AI can generate a reliable goal.",
      "goalDraftReadyHint": "The goal draft is ready. Create it directly or open the editor for final adjustments.",
      "noteCollectingHint": "Keep refining the note through chat, then create it directly in the knowledge base.",
      "noteDraftReadyHint": "Knowledge note draft is ready for review.",
      "noteCreatedHint": "Knowledge note created at {path}.",
      "knowledgeQaCollectingHint": "Ask a question from your personal knowledge base. Answers will show citations when evidence is available.",
      ...
      "ungroundedHint": "The answer is not sufficiently grounded in your note evidence, so note creation is disabled. Add sources or rephrase the question.",
      ...
      "taskCollectingHint": "Describe the task in chat, then start the Task Agent. Host task.create proposals appear in the workbench for review.",
      "taskAwaitingApprovalHint": "Review the Host task.create proposal, then approve to create the task template.",
    ...
    "hostProposals": {
      ...
      "lifecycleOnly": "Host lifecycle only — business execution runs after approval through the existing executor.",
      ...
      "editGoalId": "Linked goal id (optional)",
  ...
  "goalDraft": {
    ...
    "emptyState": "Start with a goal idea and AI will return a structured draft here for confirmation and editing.",
    "categories": {
      "product": "Product",
  ...
  "dialogs": {
    ...
    "automation": {
      ...
      "emptyState": "AI will draft the goal, choose explicit tool calls, and wait for confirmation before creating real goal or task entities.",
    ...
    "note": {
      ...
      "topicPlaceholder": "Describe the topic, source context, or what should be included in the note...",
      "savePath": "Save Path",
      "drafting": "Drafting...",
      "draft": "Draft Note",
      ...
      "emptyState": "AI will save the generated markdown note to your configured notes path and show a quick summary here.",
    ...
    "knowledgeExpansion": {
      ...
      "instructionPlaceholder": "Describe what should be expanded, clarified, or grounded from your repository knowledge...",
      "draftPlaceholder": "Optional: paste the current draft or outline here. AI will expand it using cited knowledge-note context.",
      "expanding": "Expanding...",
      "expand": "Expand Draft With Knowledge",
      "copyExpandedDraft": "Copy Expanded Draft",
      "saveExpandedDraft": "Save Expanded Draft",
      "saving": "Saving...",
      "saveHint": "Saving creates a markdown draft in the current repository so you can continue editing it locally.",
      ...
      "emptyState": "Add a draft and an instruction, and AI will expand it using cited knowledge-note excerpts.",
    ...
    "analytics": {
      ...
      "emptyState": "Ask a business-style question and AI will answer from controlled analytics context.",
  ...
  "diagnostics": {
    ...
    "knowledgeIndexNotice": "Knowledge index uses {persistenceLabel}. Vector recall: {vectorLabel} ({status}).{persistenceDetail}{vectorDetail}",
    "persistenceBackend": {
  ...
  "localVault": {
    ...
    "selectDescription": "Notes remain in the folder you select and are not uploaded while GitHub is disconnected.",
