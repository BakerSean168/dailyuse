export default {
  ...
  "privacy": {
    ...
    "searchPermissionsDescription": "Control whether other users can find you by your contact information",
  ...
  "experimental": {
    ...
    "warning": "Warning",
    "warningDescription": "Experimental features may be unstable and could be changed or removed in future versions. Enabling these features means you accept the potential risks.",
  ...
  "editor": {
    ...
    "supportedVideoSitesDescription": "Links from these sites will be automatically converted to embedded players",
    "display": "Display",
    "fontSize": "Font Size",
