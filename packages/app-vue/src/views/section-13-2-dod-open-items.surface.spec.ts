 ...
 * Residual 1036 (soft): tip focused suite numbers track Residual 1036 evidence tip (308/1335).
...
describe('§13.2 DoD open items honest audit (residual 891)', () => {
  ...
  it('records tip focused suite evidence without claiming full PR gate completion', () => {
    const sec = section132();
    expect(sec).toContain('308 文件 / 1335 测试');
    expect(sec).toContain('Residual 1036');
