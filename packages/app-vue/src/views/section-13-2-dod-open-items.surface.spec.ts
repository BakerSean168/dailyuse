 ...
 * Residual 1006 (soft): tip focused suite numbers track Residual 1006 evidence tip (293/1275).
...
describe('§13.2 DoD open items honest audit (residual 891)', () => {
  ...
  it('records tip focused suite evidence without claiming full PR gate completion', () => {
    const sec = section132();
    expect(sec).toContain('293 文件 / 1275 测试');
    expect(sec).toContain('Residual 1006');
