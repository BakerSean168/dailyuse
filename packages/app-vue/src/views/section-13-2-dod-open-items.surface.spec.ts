 ...
 * Residual 1004 (soft): tip focused suite numbers track Residual 1004 evidence tip (292/1272).
...
describe('§13.2 DoD open items honest audit (residual 891)', () => {
  ...
  it('records tip focused suite evidence without claiming full PR gate completion', () => {
    const sec = section132();
    expect(sec).toContain('292 文件 / 1272 测试');
    expect(sec).toContain('Residual 1004');
