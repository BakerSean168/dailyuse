 ...
 * Residual 1014 (soft): tip focused suite numbers track Residual 1014 evidence tip (297/1291).
...
describe('§13.2 DoD open items honest audit (residual 891)', () => {
  ...
  it('records tip focused suite evidence without claiming full PR gate completion', () => {
    const sec = section132();
    expect(sec).toContain('297 文件 / 1291 测试');
    expect(sec).toContain('Residual 1014');
