 ...
 * Residual 1030 (soft): tip focused suite numbers track Residual 1030 evidence tip (305/1323).
...
describe('§13.2 DoD open items honest audit (residual 891)', () => {
  ...
  it('records tip focused suite evidence without claiming full PR gate completion', () => {
    const sec = section132();
    expect(sec).toContain('305 文件 / 1323 测试');
    expect(sec).toContain('Residual 1030');
