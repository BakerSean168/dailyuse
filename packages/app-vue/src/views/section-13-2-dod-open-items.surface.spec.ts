 ...
 * Residual 1020 (soft): tip focused suite numbers track Residual 1020 evidence tip (300/1303).
...
describe('§13.2 DoD open items honest audit (residual 891)', () => {
  ...
  it('records tip focused suite evidence without claiming full PR gate completion', () => {
    const sec = section132();
    expect(sec).toContain('300 文件 / 1303 测试');
    expect(sec).toContain('Residual 1020');
