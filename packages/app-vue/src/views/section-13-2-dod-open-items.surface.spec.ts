 ...
 * Residual 1022 (soft): tip focused suite numbers track Residual 1022 evidence tip (301/1307).
...
describe('§13.2 DoD open items honest audit (residual 891)', () => {
  ...
  it('records tip focused suite evidence without claiming full PR gate completion', () => {
    const sec = section132();
    expect(sec).toContain('301 文件 / 1307 测试');
    expect(sec).toContain('Residual 1022');
