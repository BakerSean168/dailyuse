 ...
 * Residual 1008 (soft): tip focused suite numbers track Residual 1008 evidence tip (294/1279).
...
describe('§13.2 DoD open items honest audit (residual 891)', () => {
  ...
  it('records tip focused suite evidence without claiming full PR gate completion', () => {
    const sec = section132();
    expect(sec).toContain('294 文件 / 1279 测试');
    expect(sec).toContain('Residual 1008');
