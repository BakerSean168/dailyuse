 ...
 * Residual 1000 (soft): tip focused suite numbers track Residual 1000 evidence tip (290/1265).
...
describe('§13.2 DoD open items honest audit (residual 891)', () => {
  ...
  it('records tip focused suite evidence without claiming full PR gate completion', () => {
    const sec = section132();
    expect(sec).toContain('290 文件 / 1265 测试');
    expect(sec).toContain('Residual 1000');
