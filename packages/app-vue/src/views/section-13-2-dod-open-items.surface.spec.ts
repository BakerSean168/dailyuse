 ...
 * Residual 1032 (soft): tip focused suite numbers track Residual 1032 evidence tip (306/1327).
...
describe('§13.2 DoD open items honest audit (residual 891)', () => {
  ...
  it('records tip focused suite evidence without claiming full PR gate completion', () => {
    const sec = section132();
    expect(sec).toContain('306 文件 / 1327 测试');
    expect(sec).toContain('Residual 1032');
