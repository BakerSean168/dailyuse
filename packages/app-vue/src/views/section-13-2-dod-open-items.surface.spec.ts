 ...
 * Residual 1002 (soft): tip focused suite numbers track Residual 1002 evidence tip (291/1268).
...
describe('§13.2 DoD open items honest audit (residual 891)', () => {
  ...
  it('records tip focused suite evidence without claiming full PR gate completion', () => {
    const sec = section132();
    expect(sec).toContain('291 文件 / 1268 测试');
    expect(sec).toContain('Residual 1002');
