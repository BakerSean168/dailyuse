 ...
 * Residual 1024 (soft): tip focused suite numbers track Residual 1024 evidence tip (302/1311).
...
describe('§13.2 DoD open items honest audit (residual 891)', () => {
  ...
  it('records tip focused suite evidence without claiming full PR gate completion', () => {
    const sec = section132();
    expect(sec).toContain('302 文件 / 1311 测试');
    expect(sec).toContain('Residual 1024');
