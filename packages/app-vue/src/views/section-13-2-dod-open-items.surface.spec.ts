 ...
 * Residual 1012 (soft): tip focused suite numbers track Residual 1012 evidence tip (296/1287).
...
describe('§13.2 DoD open items honest audit (residual 891)', () => {
  ...
  it('records tip focused suite evidence without claiming full PR gate completion', () => {
    const sec = section132();
    expect(sec).toContain('296 文件 / 1287 测试');
    expect(sec).toContain('Residual 1012');
