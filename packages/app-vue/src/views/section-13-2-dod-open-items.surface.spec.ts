 ...
 * Residual 1034 (soft): tip focused suite numbers track Residual 1034 evidence tip (307/1331).
...
describe('§13.2 DoD open items honest audit (residual 891)', () => {
  ...
  it('records tip focused suite evidence without claiming full PR gate completion', () => {
    const sec = section132();
    expect(sec).toContain('307 文件 / 1331 测试');
    expect(sec).toContain('Residual 1034');
