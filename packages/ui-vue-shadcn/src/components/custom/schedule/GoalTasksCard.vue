  ...
  <Card class="h-full flex flex-col">
    <CardHeader class="flex flex-row items-center justify-between space-y-0 p-4">
      <div class="flex items-center">
        <div class="flex h-10 w-10 items-center justify-center rounded-lg bg-yellow-100 text-yellow-600 dark:bg-yellow-900/30 mr-3">
    ...
    <CardContent class="p-4 flex-1">
      ...
      <div v-if="isLoading" class="flex justify-center items-center py-8">
        <Loader2 class="h-12 w-12 animate-spin text-yellow-600" />
      </div>
