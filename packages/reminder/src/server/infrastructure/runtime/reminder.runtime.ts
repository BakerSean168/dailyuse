 ...
 *
 * Prefer concrete contributions such as `createReminderTriggerCronJob(...)`.
 * 优先使用 `createReminderTriggerCronJob(...)` 等具体贡献。
 */
export function createReminderRuntimeContribution(): ReminderModuleRuntimeContribution {
  return {
    start(): void {},
    stop(): void {},
  };
