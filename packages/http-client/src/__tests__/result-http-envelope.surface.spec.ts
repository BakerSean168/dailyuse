...
/**
 * First-party HTTP Result envelope surface (stage-6 residual 78):
 * ResultHttpClient and mobile session refresh require HttpResponse data
 * envelopes — no raw dual-track business payloads.
 */
