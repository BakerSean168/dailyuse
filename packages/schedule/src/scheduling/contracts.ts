...
/** Neutral owner of a desired set of scheduler invocations. */
...
/** Retry policy expressed without leaking the legacy ScheduleTask model. */
...
/**
 * Desired-state scheduling contract emitted by a business-owned projector.
 *
 * payloadVersion is mandatory so handlers can reject stale/incompatible payloads
 * before business code executes.
 */
