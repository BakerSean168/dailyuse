...
import { ExecutionInfo, RetryPolicy, ScheduleConfig, ScheduleTaskMetadata } from '../domain-shared/value-objects';
...
vi.mock('../application-server/scheduler/schedule-task-queue', () => {
