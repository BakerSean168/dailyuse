...
import type { EditorApplicationPort } from '../application';
import {
...
export type EditorUseCases = EditorApplicationPort;
...
export class EditorController {
  constructor(private readonly useCases: EditorApplicationPort) {}
