/**
 * createAccountModule partial-start cleanup spec.
 * createAccountModule 部分启动回滚测试。
 *
...
interface FakeContribution {
  ...
  readonly contribution: AccountModuleRuntimeContribution;
}
...
describe('createAccountModule partial-start cleanup', () => {
  ...
  it('leaves the module unstarted after a failed start: dispose is a no-op', () => {
    ...
    const instance = createAccountModule(makeDeps([a.contribution, b.contribution]));
