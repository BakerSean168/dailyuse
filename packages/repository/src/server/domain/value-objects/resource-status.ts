import { ResourceStatus as ResourceStatusContract, type ResourceStatus as IResourceStatus } from '@dailyuse/contracts/repository';
...
const VALUES: IResourceStatus[] = Object.values(ResourceStatusContract);
