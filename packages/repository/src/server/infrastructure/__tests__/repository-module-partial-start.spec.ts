/**
 * createRepositoryModule partial-start cleanup spec.
 * createRepositoryModule 部分启动回滚测试。
 *
...
interface FakeContribution {
  ...
  readonly contribution: RepositoryModuleRuntimeContribution;
}
...
function makeDeps(
  runtimeContributions: RepositoryModuleRuntimeContribution[],
...
describe('createRepositoryModule partial-start cleanup', () => {
