...
const renameMap = [
  ...
  {
    oldPath: 'packages/infrastructure-client/src/account/accountApiClient.ts',
    newName: 'account-api-client.ts',
  },
  {
    oldPath: 'packages/infrastructure-client/src/authentication/authApiClient.ts',
    newName: 'auth-api-client.ts',
  },
  {
    oldPath: 'packages/infrastructure-client/src/goal/goalApiClient.ts',
    newName: 'goal-api-client.ts',
  },
  {
    oldPath: 'packages/infrastructure-client/src/encryption/EncryptionService.ts',
    newName: 'encryption-service.ts',
  },
  {
    oldPath: 'packages/infrastructure-client/src/ai/providers/OpenAIProvider.ts',
    newName: 'openai-provider.ts',
  },
  ...
  // Infrastructure Server - Prisma Repositories
  {
    ...
    newName: 'prisma-goal-folder-repository.ts',
  },
  {
    oldPath: 'packages/infrastructure-server/src/modules/goal/repositories/PrismaGoalRepository.ts',
    newName: 'prisma-goal-repository.ts',
  },
  {
    oldPath:
      'packages/infrastructure-server/src/modules/goal/repositories/PrismaGoalStatisticsRepository.ts',
    newName: 'prisma-goal-statistics-repository.ts',
  },
  {
    oldPath:
      'packages/infrastructure-server/src/modules/goal/repositories/PrismaFocusSessionRepository.ts',
    newName: 'prisma-focus-session-repository.ts',
  },
  {
    oldPath:
      'packages/infrastructure-server/src/modules/goal/repositories/PrismaFocusModeRepository.ts',
    newName: 'prisma-focus-mode-repository.ts',
  },

  // Patterns
  { oldPath: 'packages/patterns/src/scheduler/IScheduleTimer.ts', newName: 'schedule-timer.ts' },
  {
    oldPath: 'packages/patterns/src/scheduler/IScheduleMonitor.ts',
    newName: 'schedule-monitor.ts',
  },
  {
    oldPath: 'packages/patterns/src/scheduler/priority-queue/HeapNode.ts',
    newName: 'heap-node.ts',
  },
  ...
  {
    oldPath: 'packages/domain-client/src/schedule/aggregates/ScheduleTask.ts',
    newName: 'schedule-task.ts',
  },
  {
    oldPath: 'packages/domain-client/src/schedule/value-objects/TaskMetadata.ts',
    newName: 'task-metadata.ts',
  },
  {
    oldPath: 'packages/domain-client/src/schedule/value-objects/RetryPolicy.ts',
    newName: 'retry-policy.ts',
  },
  {
    oldPath: 'packages/domain-client/src/schedule/value-objects/ExecutionInfo.ts',
    newName: 'execution-info.ts',
  },
  {
    oldPath: 'packages/domain-client/src/schedule/value-objects/ScheduleConfig.ts',
    newName: 'schedule-config.ts',
  },
];
...
for (const { oldPath, newName } of existingFiles) {
  ...
  const patterns = [
    ...
    new RegExp(
      `from\\s+['"]((?:@dailyuse|@?[\\w-]+)(?:/[\\w-]+)*/${oldFileName.replace(/\./g, '\\.')})['"]`,
      'g',
    ),
  ];
