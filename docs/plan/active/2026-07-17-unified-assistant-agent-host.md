...
- 右侧工作台统一承载 Goal/Knowledge Artifact 与审批。 **（部分：residual 355–387 Host Proposal/receipt/timeline；residual 419–427 task.create lane（live + domain + settle/receipt + AgentType 基础）；完整 Task 工作流与富编辑未齐）**
