...
- 右侧工作台统一承载 Goal/Knowledge Artifact 与审批。 **（部分：residual 355–387 Host Proposal/receipt/timeline；residual 419–423 task.create lane（live + domain executor 基础）；Task AgentType 与富编辑未齐）**
