...
| 计划                                                                                                     | 当前状态                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               |
| -------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| [MemoFlow Delivery Platform V3](./2026-09-02-delivery-platform-v3.md)                                    | **ACTIVE / Phase 3 corrective release gate**：`v0.13.2` 已绑定 immutable source `08c2daf...`；Server、Windows、macOS x64/arm64 均已通过。#317 的真实 retry `33965867292` 暴露 Linux smoke 仍错误执行 immutable `release-source` 内旧 helper，因此 control-plane 修复未生效；当前修复改为 `release-tooling` helper + exact `release-source` workspace/test，并使用 GNOME PAM `--login -> --start` Secret Service 生命周期。该 exact-source/tooling 组合已在本地 production-shaped Linux package + packaged Playwright 通过。#318 (`0.13.3`) 暂不合并；先合并 tooling 修复并重试同一 Draft，再做 production selection、Alibaba 首次受控 rollout/replay。 |
