...
| [Windows vault-repo residual handoff（1338+ 提示词）](./2026-07-25-windows-vault-repo-residual-handoff.md) | **handoff**：给 Windows 本机 agent 的收尾任务提示词；主 DoD 仍以 vault-repo plan §13.2 为准 |
| [统一助手与可插拔 Agent Host](./2026-07-17-unified-assistant-agent-host.md)                         | 待实施：统一助手、右侧工作台、Workflow/Turn/Model 可插拔边界                                                                                                       |
