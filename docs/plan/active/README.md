...
| 计划                                                                                                     | 当前状态                                                                                                                                                                                                                                                                                                                                                                                                                                                 |
| -------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| [MemoFlow Delivery Platform V3](./2026-09-02-delivery-platform-v3.md)                                    | **ACTIVE / Phase 3 corrective release gate**：`v0.13.2` 已绑定 immutable release source `08c2daf...`；Server 无重建 promotion 成功，Windows/macOS x64/macOS arm64 packaged smoke 已通过，证明 ResizeObserver 修复有效。当前唯一 Release blocker 是 Linux headless gnome-keyring `SystemPrompter` 与外层 Xvfb/D-Bus session 缺少硬上限；修复 tooling 后重试同一 Draft `v0.13.2`，不新造版本，再做 production selection、Alibaba 首次受控 rollout/replay。 |
