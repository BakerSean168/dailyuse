...
| 计划                                                                                                     | 当前状态                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           |
| -------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| [MemoFlow Delivery Platform V3](./2026-09-02-delivery-platform-v3.md)                                    | **ACTIVE / Phase 3 COMPLETE，进入 Phase 4**：`v0.13.3 -> 4e24cffd...` 已 Published；最终 selector `34005198389` 在 `controlPlaneSha=64521cf...` 下选择 set `2ea3a112...`。Alibaba 已完成 guarded BLOCKED `--force` recovery、新 DB backup、离线 Migrator、API -> PowerSync -> Web -> Caddy、local-Caddy transaction probes 与原子 `DEPLOYED`；replay 为 `already deployed`，GCP 独立公网 3 轮 9/9=200，production timer 已 enabled/active 并完成一次自动 idempotent catch-up。Phase 4 的 DLV3-4401/4402 已完成：4401 的 5 组 paired shadow 决定 **retain split**，4402 完成全仓第三方 Action SHA pinning。DLV3-4403 的 signed-notarized 能力也已实现为 fail-closed 的 app + DMG Developer ID/notary/stapler/Gatekeeper 双证明；但 GitHub 当前没有 Apple credentials，因此产品策略仍明确为 `unsigned-pilot`，尚未宣称 signed release acceptance。当前只剩 DLV3-4404 final observation/archive；未来如要 trusted-public macOS，再配置 Apple secrets 并显式切 `MACOS_RELEASE_MODE=signed-notarized`。 |
