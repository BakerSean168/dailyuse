...
| 计划                                                                                                     | 当前状态                                                                                                                                                                                                                                                                                                                                                                                                                                                |
| -------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| [MemoFlow Delivery Platform V3](./2026-09-02-delivery-platform-v3.md)                                    | **ACTIVE / Phase 3 BLOCKED recovery gate**：`v0.13.3` 已 Published，四平台 Desktop、Server promote、Prisma engine 离线闭包和 selector `33976296012` 均通过。Alibaba 仍服务 operator-restored 旧 exact runtime，v0.13.2 `BLOCKED` receipt 保留、timer disabled。当前只合入 force-recovery live-baseline guard，重新 select 同一个 v0.13.3 绑定新 controlPlaneSha，然后 check-only -> `--force` + 新 DB backup -> exact state -> replay -> timer enable。 |
