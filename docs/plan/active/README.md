...
| [Desktop Cross-Platform Runtime](./2026-08-29-desktop-cross-platform-runtime.md) | **Phase 0 active / PLAT-0001 accepted**：current platform surface inventory 已由 Pixel 实施并经 ChatGPT Web 独立验收；当前唯一继续执行点为 `PLAT-0002` capability probe harness。 |
