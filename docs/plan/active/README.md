...
| 计划                                                                                                     | 当前状态                                                                                                                                                                                                                                                                                                                                                                                |
| -------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| [MemoFlow Delivery Platform V3](./2026-09-02-delivery-platform-v3.md)                                    | **ACTIVE / Phase 3 corrective release gate**：build-once Server candidate、GCP canonical staging、candidate-bound Release promotion、production selector 与 Alibaba watcher 已实现；`v0.13.0` 在真实 Desktop packaged-runtime gate 两次 fail closed 并保持 Draft。下一真实门是 hardening 后的 `v0.13.1` Published Release，再做 production selection、Alibaba 首次受控 rollout/replay。 |
