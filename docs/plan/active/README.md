...
| 计划                                                                                                     | 当前状态                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              |
| -------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| [MemoFlow Delivery Platform V3](./2026-09-02-delivery-platform-v3.md)                                    | **ACTIVE / Phase 3 host-probe recovery gate**：`v0.13.3` 已 Published；#321 的 BLOCKED live-baseline guard 已 merge，selector `33978120212` 已按 `controlPlaneSha=3adafc21...` 重新选择 set `50163b7b...`，Alibaba exact bundle 安装/check-only 均通过且 timer 仍 disabled。force 前发现 Alibaba 自身公网 DNS/HTTPS hairpin 不可靠，但正式域名经本机 Caddy `--resolve ...:127.0.0.1` 3/3=200。当前只修 host-local Caddy transaction probe，再重新 select 同一个 v0.13.3，然后 `--force` + 新 DB backup -> exact state -> replay -> GCP public probe -> timer enable。 |
