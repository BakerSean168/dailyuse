...
| Phase 4        | **IN PROGRESS — 4401/4402 COMPLETE; 4403 CODE COMPLETE** | DLV3-4401 retained split after five real paired samples; DLV3-4402 repository-wide Action pinning is complete. DLV3-4403 now implements fail-closed app+DMG Developer ID signing/notarization trust, while the current product policy remains `unsigned-pilot` because no Apple credentials are provisioned. Only DLV3-4404 final observation/archive remains as current platform work; trusted-public macOS activation is a future credential gate.                                                                                                                                                                                                                                                                                                                                                                                                                                                                 |
...
As of 2026-09-06 the GitHub repository/environments contain no Apple Developer signing/notarization secrets and no `MACOS_RELEASE_MODE` variable. Therefore no real signed/notarized MemoFlow release has been accepted yet and existing macOS assets remain explicit internal/manual `unsigned-pilot` artifacts. This is a **conditional product activation gate**, not a blocker for the already-accepted Server production transaction. To enable trusted public macOS distribution, provision the protected Apple credentials, set `MACOS_RELEASE_MODE=signed-notarized`, and require both macOS release lanes to produce valid app+DMG trust receipts before publication.
