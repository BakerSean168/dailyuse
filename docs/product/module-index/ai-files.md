...
## ADR-035 Agent Host 生产适配（residual 314–353）
...
| [`packages/ai/src/infrastructure-client/adapters/ipc/ai-assistant-ipc.adapter.ts`](../../../packages/ai/src/infrastructure-client/adapters/ipc/ai-assistant-ipc.adapter.ts) | Desktop AssistantFacade 客户端 IPC stream 适配器 |
