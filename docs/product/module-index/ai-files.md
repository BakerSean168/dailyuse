...
| [`packages/ai/src/controllers/ai-chat.controller.ts`](../../../packages/ai/src/controllers/ai-chat.controller.ts) | Chat 控制器 |
| [`packages/ai/src/controllers/ai-goal-generation.controller.ts`](../../../packages/ai/src/controllers/ai-goal-generation.controller.ts) | 目标生成控制器 |
...
| 文件 | 说明 |
| --- | --- |
| [`packages/ai/src/domain-server/aggregates/ai-conversation.ts`](../../../packages/ai/src/domain-server/aggregates/ai-conversation.ts) | AIConversation 聚合根 |
| [`packages/ai/src/domain-server/aggregates/ai-provider-config.ts`](../../../packages/ai/src/domain-server/aggregates/ai-provider-config.ts) | AIProviderConfig 聚合根 |
| [`packages/ai/src/domain-server/entities/message.ts`](../../../packages/ai/src/domain-server/entities/message.ts) | Message 实体 |
| [`packages/ai/src/domain-server/services/ai-generation-validation-service.ts`](../../../packages/ai/src/domain-server/services/ai-generation-validation-service.ts) | AI 生成验证服务 |
| [`packages/ai/src/application-server/ports/chat-execution.port.ts`](../../../packages/ai/src/application-server/ports/chat-execution.port.ts) | Chat 执行端口 |
| [`packages/ai/src/application-server/ports/goal-planning.port.ts`](../../../packages/ai/src/application-server/ports/goal-planning.port.ts) | Goal planning 端口 |
| [`packages/ai/src/application-server/ports/knowledge-note-persistence.port.ts`](../../../packages/ai/src/application-server/ports/knowledge-note-persistence.port.ts) | 知识笔记持久化端口 |
| [`packages/ai/src/application-server/use-cases/commands/send-ai-message.use-case.ts`](../../../packages/ai/src/application-server/use-cases/commands/send-ai-message.use-case.ts) | 发送消息用例 |
| [`packages/ai/src/application-server/use-cases/commands/generate-ai-goal.use-case.ts`](../../../packages/ai/src/application-server/use-cases/commands/generate-ai-goal.use-case.ts) | 目标生成用例 |
| [`packages/ai/src/application-server/use-cases/commands/manage-ai-knowledge-note.use-case.ts`](../../../packages/ai/src/application-server/use-cases/commands/manage-ai-knowledge-note.use-case.ts) | 知识笔记管理用例 |
| [`packages/ai/src/infrastructure-server/ai.module.ts`](../../../packages/ai/src/infrastructure-server/ai.module.ts) | 服务端 AI 模块组合根 |
| [`packages/ai/src/infrastructure-server/runtime/direct-provider-ai.runtime.ts`](../../../packages/ai/src/infrastructure-server/runtime/direct-provider-ai.runtime.ts) | 直连 provider 运行时 |
| [`packages/ai/src/infrastructure-server/runtime/remote-ai-service.runtime.ts`](../../../packages/ai/src/infrastructure-server/runtime/remote-ai-service.runtime.ts) | 远程 ai-service 运行时 |
| [`packages/ai/src/infrastructure-server/security/ai-secret-cipher.ts`](../../../packages/ai/src/infrastructure-server/security/ai-secret-cipher.ts) | API key 加密（AES-256-GCM） |
...
| 文件 | 说明 |
| --- | --- |
| [`packages/ai/src/domain-server/aggregates/__tests__/ai-conversation.spec.ts`](../../../packages/ai/src/domain-server/aggregates/__tests__/ai-conversation.spec.ts) | AIConversation 聚合测试 |
| [`packages/ai/src/application-server/use-cases/commands/__tests__/ai-chat-application-service.test.ts`](../../../packages/ai/src/application-server/use-cases/commands/__tests__/ai-chat-application-service.test.ts) | Chat 应用服务测试 |
| [`packages/ai/src/application-server/use-cases/commands/__tests__/goal-generation-application-service.test.ts`](../../../packages/ai/src/application-server/use-cases/commands/__tests__/goal-generation-application-service.test.ts) | 目标生成测试 |
