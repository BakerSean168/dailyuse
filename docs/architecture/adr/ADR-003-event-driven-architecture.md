...
Memoflow 包含多个业务模块（目标、任务、提醒、通知等），这些模块之间需要通信和协作。例如：
...
- [ADR-002: DDD 架构模式](./ADR-002-ddd-pattern.md) - 领域事件是 DDD 的关键
- [ADR-001: Nx Monorepo](./ADR-001-use-nx-monorepo.md) - 事件类型在 contracts 包共享
