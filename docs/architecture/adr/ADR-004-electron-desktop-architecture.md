...
- [ADR-001: 使用 Nx Monorepo](./ADR-001-use-nx-monorepo.md) - Monorepo 支持多 App 管理
- [ADR-002: 采用 DDD 架构模式](./ADR-002-ddd-pattern.md) - 分层架构是提取的基础
- [ADR-003: 事件驱动架构](./ADR-003-event-driven-architecture.md) - 跨进程事件通信
