import pytest
from ai_service.orchestrator.registry import ToolRegistry, ToolDefinition
...
def test_tool_registry_side_effect_validation():
    ...
    with pytest.raises(ValueError, match="requires_confirmation must be True for side-effect tools"):
        ToolDefinition(
            name="create_goal",
