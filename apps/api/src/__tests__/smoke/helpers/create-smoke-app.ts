...
import {
  ...
  PauseTaskTemplateUseCase,
  ArchiveTaskTemplateUseCase,
  GetTaskInstanceUseCase,
  ListTaskInstancesByAccountUseCase,
  ListTaskInstancesByTemplateUseCase,
  ListTaskInstancesByStatusUseCase,
  GetTaskInstancesByDateRangeUseCase,
  CompleteTaskInstanceUseCase,
  SkipTaskInstanceUseCase,
  StartTaskInstanceUseCase,
  DeleteTaskInstanceUseCase,
...
export function createSmokeApp(): SmokeTestApp {
  ...
  const templateController = new TaskTemplateController({
    createTemplate: new CreateTaskTemplateUseCase(templateRepo, instanceRepo),
    getTemplate: new GetTaskTemplateUseCase(templateRepo, instanceRepo),
    listTemplates: new ListTaskTemplatesUseCase(templateRepo, instanceRepo),
    updateTemplate: new UpdateTaskTemplateUseCase(templateRepo),
    deleteTemplate: new DeleteTaskTemplateUseCase(templateRepo, instanceRepo),
    activateTemplate: new ActivateTaskTemplateUseCase(templateRepo, instanceRepo),
    pauseTemplate: new PauseTaskTemplateUseCase(templateRepo, instanceRepo),
    archiveTemplate: new ArchiveTaskTemplateUseCase(templateRepo),
  });

  const instanceController = new TaskInstanceController({
    getTaskInstance: new GetTaskInstanceUseCase(instanceRepo),
    listByAccount: new ListTaskInstancesByAccountUseCase(instanceRepo),
    listByTemplate: new ListTaskInstancesByTemplateUseCase(instanceRepo),
    listByStatus: new ListTaskInstancesByStatusUseCase(instanceRepo),
    getByDateRange: new GetTaskInstancesByDateRangeUseCase(instanceRepo),
    complete: new CompleteTaskInstanceUseCase(instanceRepo),
    skip: new SkipTaskInstanceUseCase(instanceRepo),
    start: new StartTaskInstanceUseCase(instanceRepo),
    deleteInstance: new DeleteTaskInstanceUseCase(instanceRepo),
  });
