...
import type { SettingModule } from '@dailyuse/infrastructure-server';

export function registerSettingRoutes(settingModule: SettingModule): Router {
  ...
  router.use('/user', registerSettingUserRoutes(settingModule.settingService));
  ...
  router.use('/system', registerSettingSystemRoutes(settingModule.settingService));
