...
/**
 * API-host binding for ADR-052. It delegates to the already-composed feature
 * application ports; it never constructs a Goal/Task/Reminder module and never
 * reimplements feature business rules.
 */
export class GoalPlanMutationAdapter implements GoalPlanMutationPort {
  constructor(
