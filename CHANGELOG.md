...
* **core-vnext:** integrate current vNext continuation train ([c1ad6df](https://github.com/BakerSean168/memoflow/commit/c1ad6df84f9043b44a4a4dcfdfce887c593b53c3))
* **core:** close vNext wave 1 foundations ([9982e19](https://github.com/BakerSean168/memoflow/commit/9982e1918447e8710b31f6036c338d8dc51616e0))
* **goal:** durable goal.reminder.fire handler registered in both hosts (GOAL-3202) ([395e4df](https://github.com/BakerSean168/memoflow/commit/395e4dfb26b7e7ec6b7f04ca6aa09de5eebd9928))
* **goal:** project reminders through scheduling port ([9e44d03](https://github.com/BakerSean168/memoflow/commit/9e44d030037f520960217616a7911dfdd0872b3b))
* **goal:** rebuild vnext goal surface ([44bc8b0](https://github.com/BakerSean168/memoflow/commit/44bc8b0038de7e2892a90e02aa8e894d010f15bb))
* **governance:** add schedule-notification-separation audit (NOTIF-3302) ([01e07e3](https://github.com/BakerSean168/memoflow/commit/01e07e352ea120062e1f21245b41029a395ac198))
* **label:** expose renderer catalog seam ([5d9c348](https://github.com/BakerSean168/memoflow/commit/5d9c3488e885b5ff6767bb17e2127e1f8a962f56))
* **notification:** durable NotificationRequested integration envelope (NOTIF-3301) ([edbce7a](https://github.com/BakerSean168/memoflow/commit/edbce7aec3857808a6988430b336643f6f7f0df7))
* **notification:** refresh notification center ([d4081fd](https://github.com/BakerSean168/memoflow/commit/d4081fd54ac0ab3191047093c357d022547d0734))
* **planner:** add owner-aware read projection (PLAN-4302) ([505d83e](https://github.com/BakerSean168/memoflow/commit/505d83e33895a8b6f1eeee0d6b83a483c6c062ff))
* **planner:** cut over to FullCalendar engine (PLAN-4304) ([f87ff98](https://github.com/BakerSean168/memoflow/commit/f87ff98262a4d4850c949490f9220909cd892bcd))
* **planner:** route owner-aware mutations (PLAN-4303) ([e7216a3](https://github.com/BakerSean168/memoflow/commit/e7216a334e1ddf6d81718d064a9d22135f0b75d6))
* **planner:** validate FullCalendar Standard PoC (PLAN-4301) ([b87967b](https://github.com/BakerSean168/memoflow/commit/b87967b0a3062e07ce6d47df127a88b582444bed))
...
* **release:** add dual registry distribution ([9ed7810](https://github.com/BakerSean168/memoflow/commit/9ed7810467c39f8121fe2933fed585aadcf2e145))
* **reminder:** add Routine configuration center ([fec86a0](https://github.com/BakerSean168/memoflow/commit/fec86a0ea7770ab86851a30b4f1b88e4ba8b9b37))
* **repository:** add durable GitHub installation gateway ([5c99035](https://github.com/BakerSean168/memoflow/commit/5c99035cf55c8825d376fa230d0c0e8c46579190))
* **routine:** add active usage and natural break runtime (ROUTINE-4102) ([57e134d](https://github.com/BakerSean168/memoflow/commit/57e134df535abcc045f45a6a2dc57456d03ea69f))
* **routine:** add desktop activity sensor boundary (ROUTINE-4101) ([14cc2b1](https://github.com/BakerSean168/memoflow/commit/14cc2b110dfdde9a0bc6fbf8049c4638930d22e6))
* **routine:** add deterministic intervention state machine (ROUTINE-4103) ([be94c39](https://github.com/BakerSean168/memoflow/commit/be94c3946420d4705a7baa9589cab3385e037e40))
* **routine:** add intervention window projection (ROUTINE-4104) ([d5e22c4](https://github.com/BakerSean168/memoflow/commit/d5e22c4c4e9185cb6fd4e0a9e5d6614a8efca36a))
* **routine:** add recoverable focus window (ROUTINE-4202) ([71cc34a](https://github.com/BakerSean168/memoflow/commit/71cc34afdd4ba3b7fbfbaddf6eaf180d2605cd14))
* **routine:** credit protocol breaks to ambient routines (ROUTINE-4203) ([1dd14cc](https://github.com/BakerSean168/memoflow/commit/1dd14cc8ef50099dc08e18de4cdfafa6e106cbbf))
* **routine:** durable wall-clock scheduling lane (ROUTINE-3401) ([2b81049](https://github.com/BakerSean168/memoflow/commit/2b81049371638fdf09fc5e845256cd542f40d67c))
* **routine:** persist and recover protocol sessions (ROUTINE-4201) ([6436a79](https://github.com/BakerSean168/memoflow/commit/6436a79c3af4c31e0215d09e3093c1b718773760))
* **schedule:** add common projection repair runtime (SCHED-3601) ([2fd6b19](https://github.com/BakerSean168/memoflow/commit/2fd6b1992ff090af23035693cb5144c6579bfdf3))
* **task:** finalize plan outcome settlement ([8a53343](https://github.com/BakerSean168/memoflow/commit/8a53343e4126c5659b7c495fa223bc320d3211b0))
* **task:** integrate shared label projection ([fbe64a7](https://github.com/BakerSean168/memoflow/commit/fbe64a746be1b9aa26558e4e7787960d1fdf95bf))
* **task:** project reminders through scheduling port ([9e012b8](https://github.com/BakerSean168/memoflow/commit/9e012b8fb7cd138fe75681c644a811418986784a))
* **task:** rebuild occurrence-first task surfaces ([a2c0fa0](https://github.com/BakerSean168/memoflow/commit/a2c0fa06e77dfdd914b17e191dc9195580fc1041))
* **ui:** add shared label controls (UI-5101) ([37ffb61](https://github.com/BakerSean168/memoflow/commit/37ffb613769fa90545dc7c0d2f80b00a65ec499d))


### Bug Fixes

* **app-vue:** sanitize notification presentation and navigation ([fc55c89](https://github.com/BakerSean168/memoflow/commit/fc55c896f5c4e48913546d10f6a940c19fd6f67f))
* **auth:** gate GitHub login by provider capability ([#271](https://github.com/BakerSean168/memoflow/issues/271)) ([c175f5b](https://github.com/BakerSean168/memoflow/commit/c175f5bb5c93a9b7601d5aaed4b51f89e6aed044))
* **ci:** serialize Prisma client generation ([#270](https://github.com/BakerSean168/memoflow/issues/270)) ([1170d9b](https://github.com/BakerSean168/memoflow/commit/1170d9b85fc476e8462ca2325c79b0f16eb6ac16))
* **deploy:** wire transactional email into production ([6dddfcd](https://github.com/BakerSean168/memoflow/commit/6dddfcd68032216f5b9e9ba40ad86135cdbfd91c))
* **desktop:** wire ambient routine activity runtime ([8d556f3](https://github.com/BakerSean168/memoflow/commit/8d556f3939f169942b70c34285dfa376ef53ec51))
* **docker:** include label workspace in api image closure ([e15adbe](https://github.com/BakerSean168/memoflow/commit/e15adbec9ce66de1fb6e0b59c5f818aaa391e0f5))
* **docs:** use canonical production ssh alias ([5d4e824](https://github.com/BakerSean168/memoflow/commit/5d4e824cca6c97c5ab7235524186866ff378f1c0))
* **github:** wire App installation runtime ([#272](https://github.com/BakerSean168/memoflow/issues/272)) ([16c4b0f](https://github.com/BakerSean168/memoflow/commit/16c4b0fb6558c26ea10d20059d31e0368ea45bf5))
* **goal:** enumerate PowerSync goal refs for startup reconcile ([f8610a9](https://github.com/BakerSean168/memoflow/commit/f8610a95ba1fddcd3528b2e34501a49e45fa0a34))
* **governance,notification,schedule-orchestration:** close NOTIF-3302 review findings (NOTIF-3302) ([5751bd4](https://github.com/BakerSean168/memoflow/commit/5751bd489c1752f0c62682b928ea6b535e064167))
* **migration:** preserve legacy auth during vnext rollout ([670aaea](https://github.com/BakerSean168/memoflow/commit/670aaea48a0644d3bdef792a18367d79b43d02a9))
* **notification:** backfill preference hierarchy defaults ([8a49ea6](https://github.com/BakerSean168/memoflow/commit/8a49ea6a891116b18da79651274d43d4b45235ab))
* **notification:** envelope-level idempotency and durable correlation fallback (NOTIF-3301) ([b8bb409](https://github.com/BakerSean168/memoflow/commit/b8bb409f19f5d21471e8a0b0b61adfef1d758dff))
* **notification:** harden center semantics and navigation ([cddc5fa](https://github.com/BakerSean168/memoflow/commit/cddc5fa80e8d14368a229c3b763fc1b1b4bbef23))
* **notification:** migrate legacy preference hierarchy ([1a1aafa](https://github.com/BakerSean168/memoflow/commit/1a1aafabdaeba115eec323dbfbbc1661b7eb1dbc))
...
* **release:** mirror ACR-compatible platform manifests ([834a87d](https://github.com/BakerSean168/memoflow/commit/834a87d8bf029920fb8c2a3e5299bd0d68473b1b))
* **release:** pin distribution identities by registry digest ([7ce4dbc](https://github.com/BakerSean168/memoflow/commit/7ce4dbc98ef83baac2b6a93fb2428f5ca827f215))
...
* **reminder:** persist canonical notification request envelope ([5dd4314](https://github.com/BakerSean168/memoflow/commit/5dd43149b272d676d8b394515f89df3a66d8cae0))
* **reminder:** wire protocol break credit completion ([3575a83](https://github.com/BakerSean168/memoflow/commit/3575a839dad857531092a5f3dd5124031da18ba7))
* **routine:** close local runtime integration gaps ([6b2f845](https://github.com/BakerSean168/memoflow/commit/6b2f845e35e8e5e110d2c4dd388e82c4843b3dcb))
* **routine:** durable Prisma adapters, atomic commit+notification, override reconcile (ROUTINE-3401) ([8071583](https://github.com/BakerSean168/memoflow/commit/80715836bc4754d165c94fe623fdf9f6432f4717))
* **routine:** durable snooze/suppress store; projection converges on persisted override (ROUTINE-3401) ([c7c5940](https://github.com/BakerSean168/memoflow/commit/c7c5940e66d84c211157fe12f90c495e1ab4aebf))
* **routine:** preserve break credit during recovery ([c0794c3](https://github.com/BakerSean168/memoflow/commit/c0794c312a981980c28bafdb7f2e9c8b4465e95a))
* **schedule-orchestration,notification:** bounded stale-owner sweep and Wave 3 vertical evidence ([b0ceb23](https://github.com/BakerSean168/memoflow/commit/b0ceb23c2436f45a4f3fa5828fabb84b1e3b19d2))
* **schedule-orchestration:** register task:rescheduled in Task projection runtime ([e7a03b1](https://github.com/BakerSean168/memoflow/commit/e7a03b12b821eb2822584db892537994b382ab76))
* **task,notification:** harden reminder-fire freshness and durable idempotency (TASK-3102) ([a455e0f](https://github.com/BakerSean168/memoflow/commit/a455e0f2b31f11976447b50fe0d058d49828c4be))
* **test:** align clean workspace validation boundaries ([3056943](https://github.com/BakerSean168/memoflow/commit/3056943d445a069e83b48384be1636f8074f9c89))
* **time:** ship UI date runtime dependency ([02237c3](https://github.com/BakerSean168/memoflow/commit/02237c3d54d577b36da511068202b1bc2a7cd5d8))
* **time:** ship UI date runtime dependency ([5db2332](https://github.com/BakerSean168/memoflow/commit/5db23322017a598a392d3dd5035a625bef8bd387))
* **vnext:** close notification calendar integration gaps ([885ea24](https://github.com/BakerSean168/memoflow/commit/885ea24cc3c6534a0009cdfbf6a6c9206eb3bb08))

## [0.10.0](https://github.com/BakerSean168/memoflow/compare/v0.9.0...v0.10.0) (2026-08-23)

### Highlights

* Completed the Mastra-native AI vNext cutover, retiring the legacy Python/LangGraph/AgentHost business runtime and consolidating the canonical Agent runtime in TypeScript.
* Closed the W0-W7 business reliability program across reminders, notifications, account lifecycle, Goal/Task, schedules, repository projections, settings, and operational release gates.
* Hardened authentication and production-like validation, including Better Auth flows, Tailscale MagicDNS local validation, exact image-revision evidence, and the full local-Docker browser journey.
* Completed the application/reference-architecture boundary migration with typed failure contracts, unified request/execution context, query-cache ownership, transport validation, and fail-closed governance.
* Introduced Release Lifecycle V2: explicit Prepare Release, exact-SHA CI gating, Draft-first Desktop/Docker lanes, immutable release image identities, canonical release manifests, and postflight-before-publish semantics.
...
* **api:** align local validation security headers ([#255](https://github.com/BakerSean168/memoflow/issues/255)) ([9d80795](https://github.com/BakerSean168/memoflow/commit/9d80795ca962dafbf1447dc627160d1d82ded3f3))
...
* **ci:** emit evidence for coverage no-target runs ([#254](https://github.com/BakerSean168/memoflow/issues/254)) ([1c75ebb](https://github.com/BakerSean168/memoflow/commit/1c75ebbf6190dfc924570699a82bba2b9b2096ad))
...
* **ui:** preserve focus after panel resize ([#256](https://github.com/BakerSean168/memoflow/issues/256)) ([4d05544](https://github.com/BakerSean168/memoflow/commit/4d055441f5be9d540e7ad5126522b707b3c2be35))
...
* **web:** isolate host e2e auth origins ([#257](https://github.com/BakerSean168/memoflow/issues/257)) ([7e11385](https://github.com/BakerSean168/memoflow/commit/7e11385d87d99f717016cc75a4924bc94cf2e96b))
